...
public class AdapterDashboard extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        int randomColor = random.nextInt(mColorMenu.length);
        ...
        verticalHolder.mBackgroundMenu.setBackgroundColor(mColorMenu[randomColor]);
    ...
    public class VerticalHolder extends RecyclerView.ViewHolder{
        ...
        private TextView mIcon, mTextTitle;
